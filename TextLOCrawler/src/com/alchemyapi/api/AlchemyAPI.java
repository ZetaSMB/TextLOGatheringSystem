...
public class AlchemyAPI {
    ...
    private static String _apiKey = "9992916e9a4c9de72b2b92efd2c6400801ec7506";
    ...
    {
    	_apiKey = Parameters.getInstance().alchemyApiKey();
    	return;
    	/*
    	if (null != _apiKey )
           ...
           ParserConfigurationException, XPathExpressionException
	{
	    ...
	    uri.append(_requestUri).append(callPrefix).append('/').append(callName)
	       .append('?').append("apikey=").append(AlchemyAPI._apiKey);
               ...
               ParserConfigurationException, XPathExpressionException
    {
        ...
        data.append("apikey=").append(AlchemyAPI._apiKey);
